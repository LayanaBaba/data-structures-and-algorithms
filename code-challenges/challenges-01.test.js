...
Within the addNumbers function, invoke the callback function ****as many times as necessary, based on the third argument**** ****times**** of the addNumbers function.
...
const createList = (availableItems) => {
  // Solution code here...
  let listArr=[];
  availableItems.forEach((truthy)=>{
    if (truthy.available===true){
      listArr.push(truthy.name);
    }
  });
  return listArr;
};
